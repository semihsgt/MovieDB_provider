...
import 'package:moviedb_org/Pages/Library/watchlist_controller.dart';
...
class _WatchlistPageState extends State<WatchlistPage> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => WatchlistPageController(),
      child: Consumer<WatchlistPageController>(
                  ...
                  ClipRRect(
                    ...
                    child: Image.network(
                      ...
                      loadingBuilder: (context, child, loadingProgress) {
                        return WatchlistPageController.imageNetwork(
                          context,
                          child,
                          loadingProgress,
                        );
